        ...
        if (context.metaCache.isTrunk(parentBranchName)) {
            ...
            if (!context.metaCache.isBranchFixed(branchName)) {
                throw new errors_1.ExitFailedError([
                    ...
                    `To resolve this, check out ${chalk_1.default.yellow(branchName)} and run ${chalk_1.default.cyan(`gt upstack restack`)}.`,
                ].join('\n'));
            }
        }
        else {
            if (!context.metaCache.branchMatchesRemote(parentBranchName)) {
                throw new errors_1.ExitFailedError([
                    ...
                    `You may want to use ${chalk_1.default.cyan(`gt stack submit`)} to ensure that the ancestors of ${chalk_1.default.yellow(branchName)} are included in your submission.`,
                ].join('\n'));
            }
        }
