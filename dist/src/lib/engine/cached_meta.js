...
function assertCachedMetaIsValidOrTrunk(branchName, meta) {
    if (meta.validationResult !== 'VALID' && meta.validationResult !== 'TRUNK') {
        throw new errors_1.UntrackedBranchError(branchName);
    }
}
...
function assertCachedMetaIsValidAndNotTrunk(branchName, meta) {
