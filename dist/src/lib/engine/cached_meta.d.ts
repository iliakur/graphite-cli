...
export declare function assertCachedMetaIsValidOrTrunk(branchName: string, meta: TCachedMeta): asserts meta is TValidCachedMeta;
...
export declare function assertCachedMetaIsValidAndNotTrunk(branchName: string, meta: TCachedMeta): asserts meta is TValidCachedMetaExceptTrunk;
export {};
