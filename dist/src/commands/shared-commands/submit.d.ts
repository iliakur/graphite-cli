...
export declare const args: {
    ...
    readonly 'no-edit': {
        readonly type: "boolean";
        readonly describe: "Don't edit PR fields inline. Takes precedence over --edit";
        readonly demandOption: false;
        readonly default: false;
        readonly alias: "n";
    };
    readonly reviewers: {
        readonly describe: "If set without an argument, prompt to manually set reviewers. Alternatively, accepts a comma separated string of reviewers";
    ...
    readonly select: {
        readonly describe: "Reports the PRs that would be submitted and asks the user to select which should be updated/created. If either of --no-interactive or --dry-run is passed, this flag is ignored.";
        readonly type: "boolean";
        readonly default: false;
        readonly alias: "s";
    };
    ...
    readonly force: {
        readonly describe: "Force push: overwrites the remote branch with your local branch. Otherwise defaults to --force-with-lease.";
        readonly type: "boolean";
        readonly default: false;
        readonly alias: "f";
    };
